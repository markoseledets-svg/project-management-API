...
from app.api.v1.routers import auth_routes, tasks_routes, project_routes, invitation_routes
...
router_v1.include_router(invitation_routes.router, prefix="/projects")